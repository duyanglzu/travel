...
- 路线地图：Leaflet + 高德瓦片，去程灰线(成都→泸定→中谷村→甲根坝→八美)，返程绿线(G350·道孚→八美→塔公→姑弄村→丹巴→四姑娘山→映秀→成都)
- D3 成都→泸定桥(游玩2h)→中谷村（顺路打卡，不走回头路）
- D11 双线按天气选：Plan A 丹道秘境(晴天) / Plan B G350熊猫大道(雨天/求稳)
- D11-D15 返程：道孚→丹巴→四姑娘山→映秀→重庆→武汉→上海
